...
for s = 1:nScale
    ...
    rows = [rows; table( ...
        ...
        band, rep.pc1_explained, rep.pc2_explained, rep.cum5_explained, rep.cum10_explained, ...
        ...
        'initial_band','pc1_explained','pc2_explained','cum5_explained','cum10_explained', ...
...
if P.verbose
    ...
    disp(rows(:, {'scale_index','chunk_sec','initial_band','pc1_explained','pc2_explained', ...
        'representation_dims','representation_compression_ratio', ...
...
dimensionAudit.pc1_explained = i_vector_value_or_nan(explained, 1);
dimensionAudit.pc2_explained = i_vector_value_or_nan(explained, 2);
...
rep.pc2_explained = i_vector_value_or_nan(expl, 2);
...
function value = i_vector_value_or_nan(x, idx)
x = x(:);
if numel(x) >= idx
    value = x(idx);
else
