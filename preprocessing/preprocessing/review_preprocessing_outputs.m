...
for i = 1:numel(files)
    ...
    for m = 1:nAnimals
        ...
        if ~isempty(statsAnimal) && numel(statsAnimal) >= m
            ...
            arow.nPredictionIssueFrames = getfield_safe(st, 'nPredictionIssueFrames');
            arow.nInterpolatedPredictionIssueFrames = getfield_safe(st, 'nInterpolatedPredictionIssueFrames');
            arow.nUsablePredictionIssueFrames = getfield_safe(st, 'nUsablePredictionIssueFrames');
            arow.nRepairedPredictionIssueFrames = getfield_safe(st, 'nRepairedPredictionIssueFrames');
            arow.nUnresolvedPredictionIssueFrames = getfield_safe(st, 'nUnresolvedPredictionIssueFrames');
            arow.pctPredictionIssueFrames = getfield_safe(st, 'pctPredictionIssueFrames');
            arow.pctPredictionIssueUsable = getfield_safe(st, 'pctPredictionIssueUsable');
            arow.pctPredictionIssueRepaired = getfield_safe(st, 'pctPredictionIssueRepaired');
            arow.pctPredictionIssueUnresolved = getfield_safe(st, 'pctPredictionIssueUnresolved');
            ...
            arow.nPredictionIssueFrames = NaN;
            arow.nInterpolatedPredictionIssueFrames = NaN;
            arow.nUsablePredictionIssueFrames = NaN;
            arow.nRepairedPredictionIssueFrames = NaN;
            arow.nUnresolvedPredictionIssueFrames = NaN;
            arow.pctPredictionIssueFrames = NaN;
            arow.pctPredictionIssueUsable = NaN;
            arow.pctPredictionIssueRepaired = NaN;
            arow.pctPredictionIssueUnresolved = NaN;
...
metrics = { ...
    ...
    'pctArenaFrames', ...
    'pctLowConfFrames', ...
    'pctPredictionIssueFrames', ...
    'pctPredictionIssueRepaired', ...
    'pctPredictionIssueUnresolved', ...
